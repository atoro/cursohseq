...
<body>
  <p>
    <?php 
if ($_POST["Grabar"]){
	$insertar="INSERT INTO proximoscursos (titulo_curso,contenido_curso ) ";
	$insertar.= "VALUES( '$_POST[titulo_curso]','$_POST[contenido_curso]')";
...
<form action="proximoscursos.php" method="post" name="form1" id="form1">
    <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="38" colspan="2"><div align="center" class="textos3">PROXIMOS CURSOS</div></td>
      </tr>
      <tr>
        ...
        <td valign="top"><input name="titulo_curso" type="text" id="titulo_curso" value="<?php echo $titulo_curso; ?> " size="43"></td>
      </tr>
      <tr>
        <td width="44%" height="67" align="right" valign="middle" class="Letras1"><span class="textos">Contenido : </span><span class="texto"><strong> &nbsp; </strong></span></td>
        <td width="56%"><span class="textobox">
          <textarea name="contenido_curso" cols="45" rows="4" class="Letras1" id="contenido_curso"></textarea>
        </span></td>
      </tr>
      <tr>
              ...
              <td height="230" class="margen"><table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="88%" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="31" align="left" valign="middle" class="Letras1"><a href="../imagenes/cursos_inicio/Upload_foto.php?id=<?php echo $rs["id"]; ?>" class="textos">Cambiar imagen</a></td>
                      <td width="13%" class="Letras1"><div align="left" class="Letras1"> 
                      

                      <span class="textobox">
                      
<a href="proximoscursos.php?id=<?php echo $rs["id"] ?>&action=eliminar" onClick=" return confirm('Esta Seguro que desea eliminar?');">
<img src="b_drop.png" width="16" height="16" border="0" />
</a>
                      

                      &nbsp;</span><span class="textos3">Eliminar</span></div></td>
                      <td width="52%" class="textobox"><a href="javascript:openWindow('editarproximoscursos.php?id=<?php echo $rs["id"]; ?>')"><img src="Lapiz.png" width="16" height="16" border="0"></a>  &nbsp;<span class="textos3">Editar</span><span class="textoinfo"></a></span></td>
                    </tr>
                    <tr>
                      <td width="35%" rowspan="3" valign="top" class="Letras1"><p><img src="../imagenes/cursos_inicio/<?php echo $rs["id"]; ?>.jpg" width="190" height="190"></p></td>
                    ...
                    <tr>
                      <td height="25" align="center" valign="middle" class="Letras1"><span class="textoinfo"><span class="textos">Contenido</span></span></td>
                      <td valign="top"><span class="texto">
                        <?php $texto = str_replace("\r\n","<br>",$rs["contenido_curso"]); echo $texto ?>
                      </span></td>
                    </tr>
                    <tr>
