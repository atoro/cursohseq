...
if ($_POST["Modificar"]){
	$insertar = "UPDATE proyectos SET titulo ='".$_POST["titulo"]."',subtitulo ='".$_POST["subtitulo"]."',fecha ='".$_POST["fecha"]."',contenido_breve ='".$_POST["contenido_breve"]."',contenido_completo ='".$_POST["contenido_completo"]."'   WHERE id  = '" .$_GET["id"]."' " ; 
