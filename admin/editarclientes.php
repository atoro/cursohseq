...
if ($_POST["Modificar"]){
	$insertar = "UPDATE clientes SET marca ='".$_POST["marca"]."'   WHERE id  = '" .$_GET["id"]."' " ; 
      ...
      <td width="81%" valign="top"><p>
        ...
        <table width="47%" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="81%" align="right" valign="top" class="Letras1"><input name="marca" type="text" id="marca" value="<?php echo $rs["marca"]; ?>" /></td>
          </tr>
      </table></td>
    </tr>
    <tr>
