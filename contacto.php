...
<div class="contenedor">
	...
	<div class="contenedor_info">
		<div class="inicio1">
			<h3><img src="imagenes/tic.png"> CONTACTO </h3>
      <!-- CONTACTO-->
      <form  method="post">
          ...
          <p class="tt">Indique otros requerimientos de su interés</p>

          <div class="checkbook">
            <input class="checkbook" type="checkbox" name="calidad"> Gestión de Calidad<br>
            <input class="checkbook" type="checkbox" name="ambiental"> Gestión Ambiental <br>
            <input class="checkbook" type="checkbox" name="alimentaria"> Inocuidad Alimentaria<br>
            <input class="checkbook" type="checkbox" name="seguridad"> Seguridad y Salud en Trabajo<br>
            <input class="checkbook" type="checkbox" name="empresarial"> Gestión Empresarial<br>
            <input class="checkbook" type="checkbox" name="operacional"> Excelencia Operacional<br>
            <input class="checkbook" type="checkbox" name="personas"> Gestión de Personas<br>
            <input class="checkbook" type="checkbox" name="tecnicos"> Cursos Técnicos<br>
            <input class="checkbook" type="checkbox" name="riesgos"> Gestión de Riesgos<br>
            <input class="checkbook" type="checkbox" name="energetica"> Eficiencia Energética
          </div>
...
<?php
  if ($_POST["Enviar"]){
    ...
    if( $_POST["calidad"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Gestión de Calidad</td></tr>"  ;
    }
    if( $_POST["ambiental"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Gestión Ambiental</td></tr>"  ;
    }
    if( $_POST["alimentaria"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Inocuidad Alimentaria</td></tr>"  ;
    }
    if( $_POST["seguridad"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Seguridad y Salud en Trabajo</td></tr>"  ;
    }
    if( $_POST["empresarial"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Gestión Empresarial</td></tr>"  ;
    }
    if( $_POST["operacional"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Excelencia Operacional</td></tr>"  ;
    }
    if( $_POST["personas"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Gestión de Personas</td></tr>"  ;
    }
    if( $_POST["tecnicos"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Cursos Técnicos</td></tr>"  ;
    }
    if( $_POST["riesgos"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Gestión de Riesgos</td></tr>"  ;
    }
    if( $_POST["energetica"] =="on"){
    $cuerpo .="<tr><td>PREGUNTA POR: Eficiencia Energética</td></tr>"  ;
    }
