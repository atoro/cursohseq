<?php
  ...
  if($rs=mysql_fetch_array($sentencia,$mibase)){
    ...
    $fecha = str_replace("\r\n","<br>",$rs["fecha"]);
    $contenido_completo = str_replace("\r\n","<br>",$rs["contenido_completo"]);
  }
...
<head>
	...
	<title>Detalle Consultorias hseq</title>
		...
		<div class="centro_header">
		    <nav id="menu">
		      ...
		      <ul>
		        ...
		        <li><a class="activo" href="consultorias.php">CONSULTORIAS</a></li>
...
<div class="contenedor">
	...
	<div class="contenedor_info">
		...
		<div class="inicio1">
			<h3><img src="imagenes/tic.png"> <?php $texto = str_replace("\r\n","<br>",$titulo); echo $texto ?></h3>
      <p class="sub"><?php $texto = str_replace("\r\n","<br>",$subtitulo); echo $texto ?></p>
      <div class="fecha"><?php $texto = str_replace("\r\n","<br>",$fecha); echo $texto ?></div>
			<div class="inicio_info">
				<p><?php $texto = str_replace("\r\n","<br>",$contenido_completo); echo $texto ?>
          <a href="imagenes/consultororia/pdf/<?php echo $rs["id"]; ?>.pdf" target="new">VER PDF</a>
        </p>
				<figure>
				  <img src="imagenes/consultoria/<?php echo $rs["id"]; ?>.jpg">
		     </figure>
         <div style="margin:10px 0;">
            <div class="fb-like" data-href="http://www.cursoshseq.cl/detalleconsultoria.php?id=<?php echo $rs["id"]; ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true" style="vertical-align: top; margin: 0 0 10px 0;"></div>
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.cursoshseq.cl/detalleconsultoria.php?id=<?php echo $_GET["id"]; ?>" data-lang="es" data-size="large" data-hashtags="consultoria" data-dnt="true" style="vertical-align:top;">Twittear</a>  
          </div>
			</div>
		</div>
