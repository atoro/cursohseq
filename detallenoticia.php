...
<head>
	...
	<title>Detalle Noticia hseq</title>
	...
	<div class="contenedor_info">
		<div class="inicio1">
			...
			<div class="inicio_info">
				<p><?php $texto = str_replace("\r\n","<br>",$completo_noticia); echo $texto ?>
        </p>
				<figure>
				  <img src="imagenes/noticias/<?php echo $rs["id"]; ?>.jpg">
		     </figure>
         <div style="margin:10px 0;">
            <div class="fb-like" data-href="http://www.cursoshseq.cl/detallenoticias.php?id=<?php echo $rs["id"]; ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true" style="vertical-align: top; margin: 0 0 10px 0;"></div>
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.cursoshseq.cl/detallenoticias.php?id=<?php echo $_GET["id"]; ?>" data-lang="es" data-size="large" data-hashtags="consultoria" data-dnt="true" style="vertical-align:top;">Twittear</a>  
          </div>
			</div>
		</div>
