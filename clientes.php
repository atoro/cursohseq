...
<div class="contenedor">
	...
	<div class="contenedor_info">
		<div class="inicio1">
			<h3><img src="imagenes/tic.png"> CLIENTES </h3>
      <?php 
      ...
      <div class="imgcliente">
        <img src="imagenes/clientes2/<?php echo $rs["id"]; ?>.jpg">
        <h2><?php $texto = str_replace("\r\n","<br>",$rs["marca"]); echo $texto ?></h2>
      </div>
      <?php } ?>
      
      <div style="margin: 0 0 20px 0;">
        <a style="width:200px; display:inline-block; "href="#">Descargar Lista Clientes</a>
        <a style="width:150px; display:inline-block; "href="#">Servicios Hseq</a>
      </div>
		</div>
