...
<head>
	...
	<title>Detalle Proyecto hseq</title>
		...
		<div class="centro_header">
		    <nav id="menu">
		      ...
		      <ul>
		        ...
		        <li><a class="activo" href="proyecto.php">PROYECTOS</a></li>
...
<div class="contenedor">
	...
	<div class="contenedor_info">
      ...
      <div class="fecha"><?php $texto = str_replace("\r\n","<br>",$fecha); echo $texto ?></div>
          ...
          <a href="imagenes/proyecto/pdf/<?php echo $rs["id"]; ?>.pdf" target="new">VER PDF</a>
        </p>
				<figure>
				  <img src="imagenes/proyecto/<?php echo $rs["id"]; ?>.jpg">
		     </figure>
         <div style="margin:10px 0;">
            <div class="fb-like" data-href="http://www.cursoshseq.cl/detalleproyecto.php?id=<?php echo $rs["id"]; ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true" style="vertical-align: top; margin: 0 0 10px 0;"></div>
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.cursoshseq.cl/detalleproyecto.php?id=<?php echo $_GET["id"]; ?>" data-lang="es" data-size="large" data-hashtags="proyecto" data-dnt="true" style="vertical-align:top;">Twittear</a>  
          </div>
			</div>
		</div>
